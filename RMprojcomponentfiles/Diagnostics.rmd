DIAGNOSTIC TESTS:
       %pValues, degrees of freedom, t value, hatvalues,residuals
        residuals vs fitted,R^2, QQ plots, rstandard, rstudent, dffits
        dfbeta, dfbestas, covratio, cook's distance, influence.measures
        

This plot of Resid(fit) produces a random distribution with a single outlier at a 
