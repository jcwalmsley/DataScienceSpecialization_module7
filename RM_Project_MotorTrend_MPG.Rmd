...
g
cor.test(mtcars$am, mtcars$cyl);cor.test(mtcars$am, mtcars$disp)
cor.test(mtcars$am, mtcars$wt);cor.test(mtcars$cyl, mtcars$disp)
cor.test(mtcars$cyl, mtcars$disp);cor.test(mtcars$cyl, mtcars$wt)
