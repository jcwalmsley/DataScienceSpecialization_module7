...
```{r Fig.7_MVLM(allvars,-1), echo=FALSE,  eval=c(1,2,5:12), fig.align='center', fig.height=7,fig.width=9, message=FALSE, warning=FALSE, include=FALSE, results='hide'}
library(car);library(ggplot2)
...
```{r MVLM_ANOVA_table.test, message=FALSE, warning=FALSE, include=FALSE, results='hide'}
