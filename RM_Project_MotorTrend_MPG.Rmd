...
# Grading - Criteria (remove on completion of work)!!!  
...
```{r Histogram Figure 0, echo=FALSE, fig.height=5, fig.width=5, message=FALSE, warning=FALSE}
data(mtcarsProc)
...
```{r Box Plot Figure 1, echo=FALSE, fig.height=7, fig.width=5}
data("mtcarsProc")
boxplot(mpg ~ am, data = mtcarsProc, col = (c("yellow","lightblue")), ylab = "Miles-Per-Gallon", xlab = "Transmission", main =  "Automatic vs Manual Transmission Miles Per Gallon")
```
---                

## Scatter Plot
---
```{r Scatter Plot Figure 1, echo=FALSE, fig.height=, fig.width=5}
# NOTE USE GGPLOT
# 
```
