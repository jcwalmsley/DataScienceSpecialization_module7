...
# III. Analysis Considerations:
        ...
        adjustments, residuals (predict fit, residual fit (-1)),  
        hatvalues, variation & dfbetas, R^2, diagnostics; GLMs & Binary GLMs,  
        coeficients, correlation, confint, ChiSq-Test, VIF, binary, binomial, poisson
...
## Pairs
```{r Pairs1, echo=TRUE, fig.height=6, fig.width=6}
data("mtcars")
png(Pairs1 = "plotPairs1.png")
par(mfrow = c(1, 1), cex = 0.6)
Pairs <- pairs(mpg ~ ., data = mtcars[,c(1,6,9)])
Pairs
dev.off()
```
