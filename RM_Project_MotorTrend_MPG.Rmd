...
Executive Summary:                      
        ...
        model fit we idendified a model with (wt + qsec + am) that provides an 84.966 R^2 value
        inidicating a reasonalby good and closeley matched a slightly different fit devloped using the  
