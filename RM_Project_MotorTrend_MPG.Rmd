...
# X.Preliminary Findings:  
        ...
        Interpretation of Results:
                A Based on the ANOVA table we can determine that model 4 has significance for (wt)
                B
                C
...
## Pairs
```{r Pairs, echo=TRUE, fig.height=5.5, fig.width=5.5}
data(mtcars)
...
## Histograms
```{r HistFigure1, echo=TRUE, fig.height=6.5, fig.width=6.5}
data(mtcars)
png(HistFigure1 = "HistFigure1.png")
op <- par()
...
abline(v=mean(mtcars$mpg[mtcars$am=="Manual"]), col="blue", lwd = 4); dev.off()
```
