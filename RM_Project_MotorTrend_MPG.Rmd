...
```{r Histogram Figure 1, echo=FALSE, fig.height=5, fig.width=5, message=FALSE, warning=FALSE}
data(mtcarsProc)
...
```
# OR
```{r Histogram Figure 2, echo=FALSE, fig.height=5, fig.width=5}
data(mtcarsProc)
...
```{r Box Plot Figure 1, echo=FALSE, fig.height=5, fig.width=5}
data("mtcarsProc")
