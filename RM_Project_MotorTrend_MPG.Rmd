...
```{r ModelFitStep, echo=TRUE, eval=FALSE, message=FALSE, warning=FALSE, cache=TRUE, include=FALSE,  results='hide'}
...
# Preliminary findings: 
        ...
        C Direction, Magnitude, Uncertainty
                A.
# Multivarite Linear Model Finding Best Fit with Step function:
```{r MVLM_Step_R^2, echo=TRUE, eval=TRUE, fig.align='center', fig.height=4, fig.width=7, message=FALSE, warning=FALSE, include=TRUE, results='asis'}
...
```{r Fig.1_Multiplot, echo=FALSE, fig.align='center', fig.height=6, fig.width=6.5, message=FALSE, warning=FALSE}
