...
any(is.na(mtcars));data(mtcars);library(car);library(dplyr)
r1 <- sapply(mtcars, range, simplify = TRUE);r1;mu1 <- sapply(mtcars, mean, simplify = TRUE);mu1
sd1 <- sapply(mtcars, sd, simplify = TRUE);sd1;var1 <- sapply(mtcars, var, simplify = TRUE);var1
