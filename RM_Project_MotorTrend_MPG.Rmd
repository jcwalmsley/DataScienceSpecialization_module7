...
rm(list = ls()); data("mtcars"); any(is.na(mtcars)); head(mtcars,5)
```
---
# Processing the data:
        Transformations;  
...
# Appendix A
                Pairs
```{r Pairs plot, echo=FALSE, fig.height=5.5, fig.width=5.5}
pairs(mpg ~ ., data = mtcars)
```
---                
                Histograms
```{r Hist plot, echo=FALSE, fig.height=4, fig.width=4, message=FALSE, warning=FALSE}
data("mtcars"); require(ggplot2); require(dplyr);
hist(mtcars$mpg, breaks=15, xlab = "Miles-Per-gallon", main = "MPG Histogram", xlim = range(5:40))
```
---                
                Box Plots
```{r Box plot, echo=FALSE, fig.height=4, fig.width=4}
boxplot(mpg ~ am, data = mtcars, col = (c("grey","grey")), ylab = "Miles-Per-Gallon", xlab = "Transmission", main =  "Boxplot MPG")
```
---                
                QQ Plots
```{r QQ plot, echo=FALSE, fig.height=4, fig.width=4}
#qqPlot(fit?, main="Q-Q plot")
```
---                
                Fitted
```{r Fitted plot, fig.height=4, fig.width=4}

```
---                
                Residuals
```{r Residual plot, echo=FALSE, fig.height=4, fig.width=4}
#plot(resid(fit?))
#abline(h=0)
```
---                
                Residuals vs Fitted
```{r Residuals vs Fitted plot, echo=FALSE, fig.height=4, fig.width=4}
# To be decided
